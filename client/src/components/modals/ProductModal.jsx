...
const ProductModal = ({ modalOpen, modalHandler }) => {
  ...
  return (
    <div
      ...
      } fixed top-0 z-50 justify-center items-center w-full h-full bg-slate-400 bg-opacity-75`}
    >
      <div className="relative flex flex-col gap-8 p-10 h-5/6 bg-white rounded-md overflow-y-scroll scroll-smooth">
        <img
          className="absolute top-4 left-4 w-6 cursor-pointer"
          src="/cross-icon.svg"
          alt=" "
          onClick={() => {
            modalHandler();
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-4">
              ...
              <p className="text-lg font-semibold">
                Marca: <span className="text-slate-400">lorem ipsum</span>
              </p>
              <p className="text-lg font-semibold">
                Peso: <span className="text-slate-400">lorem ipsum</span>
              </p>
              <p className="text-lg font-semibold">
                Tipo: <span className="text-slate-400">lorem ipsum</span>
              </p>
              <p className="text-lg font-semibold">
                Ingredientes:{" "}
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="flex gap-2">
                <div className="flex gap-4 items-center py-1 px-2 border-2 border-[#f0f0f0] rounded">
                  <button
                    className="text-xl font-bold px-3 py-1 bg-[#f0f0f0] rounded-sm"
                    onClick={(e) => {
                      amountHandler(e);
                    }}
                  >
