  ...
  return (
    <>
      <div className="relative border-[1px] border-grayishGreen4 rounded-2xl overflow-hidden">
        <p
          className={`absolute w-24 py-2 text-center text-xs text-white rounded-br-[1.25rem]  
                    ${
                      category === "Sin TACC"
                        ? "bg-greenLabel"
                        : category === "Vegano"
        ...
        <div className="flex flex-col p-4">
          <img
            className="block w-full max-w-full aspect-square object-cover cursor-pointer"
            src={image}
            alt={`imagen de ${name}`}
            onClick={() => {
              modalHandler();
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-darkGreen1 truncate leading-6 max-w-[25ch]">
              {name}
            </h3>
            ...
            <button
              ...
              className={`flex items-center gap-2 self-center py-2 px-4 text-sm  
                                                                                          ${
                                                                                            addedToCart
