    ...
    return(
        <div className={`${isOpen ? 'block' : 'hidden'} absolute top-full z-50 py-8 w-[120%] bg-[#f7f7f8]`}>
            <ul>    
                ...
                <li className="pl-4 hover:font-bold hover:bg-gradient-to-r from-grayishGreen4 to-25%"><NavLink className="flex items-center gap-4 py-4 px-8 text-darkGreen1 hover:text-avocadoGreen" to="/orders"><img src="/order-icon.svg" alt=" " /> Mis pedidos</NavLink></li>
